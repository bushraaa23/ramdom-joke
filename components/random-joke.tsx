...
export default function RandomJoke() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-br to-pink-500 from-fuchsia-400 p-4">
      ...
      <div className="bg-white rounded-2xl shadow-lg p-8 w-full max-w-md">
        ...
        <div className="bg-[#968cad] rounded-lg p-6 mb-6 text-[#e6ebe8] font-bold">
          {joke || "Loading..."}
        </div>
